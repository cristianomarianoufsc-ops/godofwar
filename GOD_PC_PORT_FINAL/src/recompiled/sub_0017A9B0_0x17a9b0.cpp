...
void sub_0017A9B0_0x17a9b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // PASSO 28 — rastreamento de sub_0017A9B0 (JAL[11/11] de sub_00138D48)
    // Esta funcao chama 3 sub-funcoes: func_21FEF0, func_26BB30, func_17C050.
    // Uma delas provavelmente cria/inicia a render thread do jogo.
    // Bug AM: antes desta correcao, PASSO 22B nao fazia jr $ra, causando retorno
    // prematuro de sub_0017A940 — sub_0017A9B0 nunca era chamado.
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: START — JAL[11/11] de sub_00138D48\n");
    ...
    ctx->pc = 0x21FEF0u;
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: chamando func_21FEF0 (0x21FEF0) a0=0x%x\n", GPR_U32(ctx, 4));
    ...
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: func_21FEF0 retornou v0=0x%x pc=0x%x\n", GPR_U32(ctx, 2), ctx->pc);
    ctx->pc = 0x17A9C0u;
    // 0x17a9c0: 0xc09aecc  jal         func_26BB30
    ctx->pc = 0x17A9C0u;
    SET_GPR_U32(ctx, 31, 0x17A9C8u);
    ctx->pc = 0x26BB30u;
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: chamando func_26BB30 (0x26BB30) a0=0x%x\n", GPR_U32(ctx, 4));
    ...
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: func_26BB30 retornou v0=0x%x pc=0x%x\n", GPR_U32(ctx, 2), ctx->pc);
    ctx->pc = 0x17A9C8u;
    // 0x17a9c8: 0xc060ccc  jal         func_183330
    ctx->pc = 0x17A9C8u;
    SET_GPR_U32(ctx, 31, 0x17A9D0u);
    ctx->pc = 0x183330u;
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: chamando func_183330 (0x183330) a0=0x%x\n", GPR_U32(ctx, 4));
    ...
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: func_183330 retornou v0=0x%x pc=0x%x\n", GPR_U32(ctx, 2), ctx->pc);
    ctx->pc = 0x17A9D0u;
    // 0x17a9d0: 0xc05f014  jal         func_17C050
    ctx->pc = 0x17A9D0u;
    SET_GPR_U32(ctx, 31, 0x17A9D8u);
    ctx->pc = 0x17C050u;
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: chamando func_17C050 (0x17C050) a0=0x%x\n", GPR_U32(ctx, 4));
    ...
    std::fprintf(stderr, "[PASSO 28] sub_0017A9B0: func_17C050 retornou v0=0x%x pc=0x%x — DONE\n", GPR_U32(ctx, 2), ctx->pc);
    ctx->pc = 0x17A9D8u;
