...
// O PS2Recomp originalmente truncou esta funcao para 1 instrucao porque o
// range 0x2947c8-0x2948a0 esta dentro de sub_00294760 (0x294760-0x2948a0).
// Fix manual: extraido das linhas 171-479 de sub_00294760_0x294760.cpp,
// que comecam exatamente em ctx->pc = 0x2947C8u.
void FUN_002947c8_0x2947c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("FUN_002947c8_0x2947c8");
#endif
