...
// Function: FUN_0026a438
// Address: 0x26a438 - 0x26a440
void FUN_0026a438_0x26a438(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("FUN_0026a438_0x26a438");
#endif
