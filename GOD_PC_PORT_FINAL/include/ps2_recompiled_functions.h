...
void sub_0010B0C8_0x10b0c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime);
...
void sub_001A1B58_0x1a1b58(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime);
...
void sub_002345E0_0x2345e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime);
...
void sub_002457A8_0x2457a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime);
...
void sub_0025B630_0x25b630(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime);
...
void sub_00264AB0_0x264ab0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime);
