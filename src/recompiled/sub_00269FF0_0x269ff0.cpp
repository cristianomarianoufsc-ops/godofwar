...
// Function: sub_00269FF0
// Address: 0x269ff0 - 0x26a088
void sub_00269FF0_0x269ff0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_00269FF0_0x269ff0");
#endif

    ctx->pc = 0x269ff0u;

    // 0x269ff0: 0x27bdfff0  addiu       $sp, $sp, -0x10
    ctx->pc = 0x269ff0u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967280));
    // 0x269ff4: 0xffbf0000  sd          $ra, 0x0($sp)
    ctx->pc = 0x269ff4u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
    // 0x269ff8: 0xac800004  sw          $zero, 0x4($a0)
    ctx->pc = 0x269ff8u;
    WRITE32(ADD32(GPR_U32(ctx, 4), 4), GPR_U32(ctx, 0));
    // 0x269ffc: 0xc077c50  jal         func_1DF140
    ctx->pc = 0x269FFCu;
    SET_GPR_U32(ctx, 31, 0x26A004u);
    ctx->pc = 0x26A000u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x269FFCu;
            // 0x26a000: 0x8cc40000  lw          $a0, 0x0($a2) (Delay Slot)
    ...
    if (runtime->hasFunction(0x1DF140u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x26A004u; }
        if (ctx->pc != 0x26A004u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
    ...
    ctx->pc = 0x26A004u;
    // 0x26a004: 0xdfbf0000  ld          $ra, 0x0($sp)
    ctx->pc = 0x26a004u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
    // 0x26a008: 0x3e00008  jr          $ra
    ctx->pc = 0x26A008u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x26A00Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26A008u;
            // 0x26a00c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    ...
    ctx->pc = 0x26A014u;
    {
        ...
        ctx->pc = 0x26A018u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26A014u;
            // 0x26a018: 0xffbf0000  sd          $ra, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x26A01Cu;
    // 0x26a01c: 0x8c830008  lw          $v1, 0x8($a0)
    ctx->pc = 0x26a01cu;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 8)));
    // 0x26a020: 0x8c620000  lw          $v0, 0x0($v1)
    ctx->pc = 0x26a020u;
    SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 0)));
    // 0x26a024: 0x84440010  lh          $a0, 0x10($v0)
    ctx->pc = 0x26a024u;
    SET_GPR_S32(ctx, 4, (int16_t)READ16(ADD32(GPR_U32(ctx, 2), 16)));
    // 0x26a028: 0x8c420014  lw          $v0, 0x14($v0)
    ctx->pc = 0x26a028u;
    SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 20)));
    // 0x26a02c: 0x40f809  jalr        $v0
    ctx->pc = 0x26A02Cu;
    {
        ...
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26A02Cu;
            // 0x26a030: 0x642021  addu        $a0, $v1, $a0 (Delay Slot)
    ...
    ctx->pc = 0x26A034u;
label_26a034:
    // 0x26a034: 0xdfbf0000  ld          $ra, 0x0($sp)
    ctx->pc = 0x26a034u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
    // 0x26a038: 0x3e00008  jr          $ra
    ctx->pc = 0x26A038u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x26A03Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26A038u;
            // 0x26a03c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        switch (jumpTarget) {
...
label_26a074:
    ...
    // 0x26a078: 0xdfbf0000  ld          $ra, 0x0($sp)
    ctx->pc = 0x26a078u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
label_26a07c:
    // 0x26a07c: 0x3e00008  jr          $ra
    ctx->pc = 0x26A07Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x26A080u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26A07Cu;
            // 0x26a080: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        switch (jumpTarget) {
