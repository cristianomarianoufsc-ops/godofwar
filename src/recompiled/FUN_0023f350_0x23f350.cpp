...
// Function: FUN_0023f350
// Address: 0x23f350 - 0x23f36c
void FUN_0023f350_0x23f350(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("FUN_0023f350_0x23f350");
#endif
