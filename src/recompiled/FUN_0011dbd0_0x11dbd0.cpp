...
// Function: FUN_0011dbd0
// Address: 0x11dbd0 - 0x11dbec
void FUN_0011dbd0_0x11dbd0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("FUN_0011dbd0_0x11dbd0");
#endif
