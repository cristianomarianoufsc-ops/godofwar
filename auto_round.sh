...
GREP_PATTERN="PARTE 10 PLANO|Unknown syscall|VBlank tick #[0-9]*000 |sceSifSetDma|SIGSEGV|Morto|CreateThread|StartThread|stub:|INTC:|CreateSema|WaitSema|SignalSema|boot-loop:suspect|GAME_MODE|DelayThread|SleepThread|ThreadEntry|ExitThread|TerminateThread|PASSO 3[abcd]|PollSema forj|notify2a1710|rpcBusy2a1734|sifClient2a28d0|FUN_002962d8|FUN_00296300|sub_002963C0|sub_00295568|func_295218|func_2952C8|WaitEventFlag|SetEventFlag|CreateEventFlag|mode_compat|Bug AB|Bug R|boot_stub.*entry|Starting execution|BOOT#|SyscallOverride|poll_327a40|FUN_002947c8|BugP_entry|BugP_exit|entry_1389d8|PASSO 5 FIRE|PASSO 6|PASSO 7|PASSO 11|PASSO 12|PASSO 13|sub_0013DC78|sub_0017AA18|sub_0027C100|sub_0027C2A0|sub_00282148|entry_281510|entry_27d5b8|sub_00294AF8|sub_00283570|sub_00297290|sub_0027A810|sub_0017BC80|sub_0027A6B8|sub_0027A648|entry_27ab00|138D48.*retornou"
